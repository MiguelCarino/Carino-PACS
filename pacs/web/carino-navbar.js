/* ============================================================
   ...
   the dashboard works with no network at all. Keep the clock cycle
...
(function () {
  ...
  // Clock display modes: 0 local, 1 UTC, 2 epoch, 3 TAI, 4 .beats. Click to cycle.
  var CLOCK_MODES = 5;
  ...
  // Swatch Internet Time: Biel Mean Time (UTC+1), 1 beat = 86.4s, no zones.
  function beats(d) {
    var ms = (d.getTime() + 3600000) % 86400000;
  ...
  // event handlers and ids are preserved.
